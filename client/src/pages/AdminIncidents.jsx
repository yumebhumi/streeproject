...
const AdminIncidents = () => {
    ...
    const filteredIncidents = incidents.filter((incident) => {
        return statusFilter === 'all' ? true : incident.status === statusFilter;
    });
                ...
                <table>
                    ...
                    <tbody>
                        {filteredIncidents.map((incident, index) => {
                            const reporterName = incident.isAnonymous ? 'Anonymous' : (incident.name || incident.user?.userName || 'Unknown');
                            return (
                                <tr key={index}>
                                    <td>{reporterName}</td>
